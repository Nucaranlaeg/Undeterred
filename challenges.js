...
let challenges = {
	...
	Restless: new Challenge("Restless", "Delve, but there is no healing between levels and all enemies gain significant max health (x10) and regeneration (equal to original max health).", () => {}, "+10% regen effectiveness", []),
